    ...
    <Container useStyle={false}>
      <div className={styles.privacyPolicy}>
        <div className={`${styles.privacyPolicy} ${styles.container}`}>
          ...
          <h2>1. INTRODUÇÃO</h2>
          <p>
            1.1 Bem-vindo à Encontrar, administrada pela SHPS Tecnologia e Serviços Ltda. A Encontrar respeita as leis
            de privacidade e os direitos dos Usuários da Plataforma...
          </p>
